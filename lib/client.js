...
__export(index_exports, {
  ...
  buildMismatchText: () => buildMismatchText,
...
var FALLBACK_MODEL_ID = "deepseek-v4-flash";
...
function buildMismatchText(state) {
  const host = state.hostBuild;
  if (host === void 0 || host === BUILD_STAMP) return void 0;
...
var BalanceSection = (0, import_react.memo)(function BalanceSection2({ state, onRefresh }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    mismatch !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-lwgu-note", "data-tone": "warn", children: mismatch })
  ] });
});
...
function TimeSlotIndicator({ useProjection, sessionId }) {
  ...
  const sessionPriced = lookupPricing(sessionModelId) !== void 0;
  const activeModelId = pickedModelId ?? (sessionModelId !== null && sessionPriced ? sessionModelId : FALLBACK_MODEL_ID);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-lwgu-sep", "aria-hidden": "true", children: "|" }),
