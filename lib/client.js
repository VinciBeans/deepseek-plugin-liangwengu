...
function buildStatus(state) {
  ...
  if (host === void 0) return { text: `\u6784\u5EFA ${BUILD_STAMP}\uFF08\u5BBF\u4E3B\u672A\u4E0A\u62A5\uFF09`, mismatch: false };
...
var BalanceSection = (0, import_react.memo)(function BalanceSection2({ state, onRefresh }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-lwgu-note", "data-tone": build.mismatch ? "warn" : void 0, children: build.text })
  ] });
});
