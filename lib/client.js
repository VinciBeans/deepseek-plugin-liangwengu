...
function createBalanceStore(callStatus = callBalanceStatus) {
  ...
  const arm = () => {
    ...
    timer = setTimeout(() => {
      void poll().then(arm);
    }, nextPollDelayMs(state.failureCount, state.pollIntervalMs));
  };
  const poll = async () => {
    if (inFlight) return;
    inFlight = true;
...
function TimeSlotIndicator({ useProjection, sessionId }) {
  ...
  const [balanceState, setBalanceState] = (0, import_react.useState)(() => balance.getSnapshot());
  (0, import_react.useEffect)(() => {
  ...
  const countdownId = (0, import_react.useId)();
  ...
  const rate2 = rateAt(activeEntry.pricing, at, tier);
  const upcomingGroups = /* @__PURE__ */ new Map();
  for (const entry of OFFICIAL_MODELS) {
    const nextRev = nextRevision(entry.pricing, at);
    if (nextRev === void 0) continue;
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh-lwgu-line", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-lwgu-sep", "aria-hidden": "true", children: "\xB7" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh-lwgu-countdown", id: countdownId, children: [
              "\u5269\u4F59 ",
              countdown
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh-lwgu-balance", "data-tone": balanceToneValue, children: [
            "\u4F59\u989D ",
            balanceText
          ] })
        ]
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          [...upcomingGroups].map(([nextRev, names]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-lwgu-note", children: [
            formatBeijingDateTime(nextRev.effectiveFrom),
            " \u8D77 ",
            names.join(" / "),
            " \u8C03\u4EF7\uFF1A \u547D\u4E2D ",
            formatRate(nextRev[tier].cacheHit),
            " / \u672A\u547D\u4E2D ",
            formatRate(nextRev[tier].cacheMiss),
            "/ \u8F93\u51FA ",
            formatRate(nextRev[tier].output),
            "\uFF08",
            tierLabel(tier),
            "\uFF09"
          ] }, names[0])),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-lwgu-composite", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-lwgu-composite-value", children: composite === null ? "\u2014" : formatMoney(composite) }),
          ...
          revision.effectiveFrom > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-lwgu-note", children: "\u6574\u6BB5\u4F1A\u8BDD\u7528\u91CF\u7EDF\u4E00\u6309\u8C03\u4EF7\u540E\u5355\u4EF7\u6298\u7B97\uFF0C\u8C03\u4EF7\u524D\u7684\u5386\u53F2\u7528\u91CF\u672A\u5206\u6BB5\u8FD8\u539F\u3002" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-lwgu-head", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                ...
                children: balanceState.loading ? "\u67E5\u8BE2\u4E2D\u2026" : "\u5237\u65B0"
              }
            )
          ] }),
          balanceEntries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-lwgu-note", children: balanceEmptyText(balanceState) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-lwgu-note", children: [
              "\u53EF\u7528\uFF1A",
              balanceState.isAvailable === false ? "\u4E0D\u53EF\u8C03\u7528" : "\u53EF\u8C03\u7528",
              " \xB7 ",
              "\u66F4\u65B0\u4E8E ",
              balanceUpdatedText(balanceState)
            ] })
          ] }),
          balanceState.lastError !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-lwgu-note", children: balanceErrorText(balanceState.lastError) })
        ]
      }
    )
  ] });
